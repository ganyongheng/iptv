...
@TableName("mobile_user_product_aiqiyi")
public class MobileUserProductAiqiyi extends MobileUserProductBase implements Serializable {

    private static final long serialVersionUID = 762645271807214891L;
