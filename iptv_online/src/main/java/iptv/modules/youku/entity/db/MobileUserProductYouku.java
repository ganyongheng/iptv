...
@TableName("mobile_user_product_youku")
public class MobileUserProductYouku extends MobileUserProductBase implements Serializable {

    private static final long serialVersionUID = -1704371897193484542L;
